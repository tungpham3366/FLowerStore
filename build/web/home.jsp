<%-- 
    Document   : home
    Created on : Jul 6, 2023, 4:14:17 PM
    Author     : PC
--%>
        ...
        <div class="main-content-wrapper d-flex clearfix">
            ...
            <div class="products-catagories-area clearfix">
                ...
                <h3 style="color: #333;
                    ...
                    text-align: center;
                    margin-top: 20px;
                    margin-bottom: 10px; background-color: orange ">Most Product Sale</h3>
                    ...
                    <c:forEach items="${requestScope.product}" var="p">
                        <div class="single-products-catagory clearfix">
                            <a href="product-details?flower_id=${p.flower_id}">
                                <div style="width: 500x; height: 450px; margin: 30px;">
                                    <img style="width: 500px; height: 450px; object-fit: cover;" src="${p.images}" alt="">
                                </div>
                                <!-- Hover Content -->
                ...
                <h3 style="color: #333;
                    ...
                    text-align: center;
                    margin-top: 20px;
                    margin-bottom: 10px; background-color: orange ">Popular VietNam's Product</h3>
                <div class="amado-pro-catagory clearfix">

                    <!-- Single Catagory -->
                    <c:forEach items="${requestScope.product3}" var="p">
                        <div class="single-products-catagory clearfix">
                            <a href="product-details?flower_id=${p.flower_id}">
                                <div style="width: 500x; height: 450px; margin: 30px;">
                                    <img style="width: 500px; height: 450px; object-fit: cover;" src="${p.images}" alt="">
                ...
                <h3 style="color: #333;
                    ...
                    text-align: center;
                    margin-top: 20px;
                    margin-bottom: 10px; background-color: orange ">You Might Want to Know</h3>
                <div class="amado-pro-catagory clearfix">
