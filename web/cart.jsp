<%-- 
    Document   : cart
    Created on : Jul 6, 2023, 4:21:54 PM
    Author     : PC
--%>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="cart_product_img">
                                            <a href="#"><img src="${i.product.images}" alt="Product"></a>
                                        </td>
                                        <td class="cart_product_desc">
                                            <h5>${i.product.name}</h5>
                                        </td>
                                        <td class="price">
                                            <span><fmt:formatNumber pattern="##.#" value="${i.price}"/></span>
                                        </td>
                                        <td class="qty">
                                            <div class="qty-btn d-flex">
                                                ...
                                                <div class="quantity">
                                                    ...
                                                    <input type="number" class="qty-text" id="qty" step="1" min="1" max="300" name="quantity" value="${i.quantity}">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-table">
                                ...
                                <li><span>delivery:</span> <span>Free</span></li><hr>
                                <li><span>total:</span> <h3><fmt:formatNumber pattern="##.#" value="${o.totalMoney}"/></h3></li>
                            </ul>
